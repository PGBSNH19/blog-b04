...
9. Review the .yml-code generated for you, it should look like this: 
   ![https://cdn.discordapp.com/attachments/280760711620067330/754712484727881848/unknown.png](https://cdn.discordapp.com/attachments/280760711620067330/754712484727881848/unknown.png)

That's it. The pipeline is now created. In the next steps we will configure the pipeline for continuous integration.



## Add continuous integration / delivery to your Azure DevOps pipeline.

First, we need to make sure that we are authorized to use the Azure resources with our pipelines. 
